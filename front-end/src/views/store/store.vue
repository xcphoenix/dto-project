...
<template>
  <div id="store">
    ...
    <div class="skeleton-loading" v-if="!poi_info.restaurantName">
      <img src="../../assets/restaurant.jpg">
    </div>
    <!--头部商家信息-->
    <div class="head-container">
      <!--头部-->
      <v-head :title="poi_info.restaurantName" goBack="true" color="#fff" bgColor="#333" more="true"></v-head>
      <!--商家信息-->
      <div class="store-info">
        <div class="logo">
          <img :src="poi_info.logo">
        </div>
        <div class="deliver-info">
          <span>{{poi_info.minPrice}}  | {{poi_info.deliveryPrice}} | {{poi_info.deliveryTime}}</span>
