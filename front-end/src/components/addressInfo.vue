    ...
    <form>
      ...
      <div class="name">
        ...
        <div class="input-container">
          <input type="text" v-model="formData.contact" id="name" placeholder="请填写收货人的姓名">
        </div>
      </div>
      <div class="phone">
      ...
      <div class="house-number">
        ...
        <div class="input-container">
          <input type="text" v-model="formData.address_detail" id="house-number" placeholder="例:16号楼427室">
        </div>
      </div>
    </form>
  </div>
